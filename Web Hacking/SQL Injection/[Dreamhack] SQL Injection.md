...
웹 서비스는 이용자의 입력을 SQL 구문에 포함해 요청하는 경우가 있습니다. 예를 들면, 로그인 시 ID/PW나 게시글의 제목과 내용을 SQL 구문에 포함합니다.

이때 SQL 구문에 정상적인 입력이 아닌 조작된 쿼리를 삽입하여 인증을 우회하거나, 데이터베이스의 정보를 유출하는 행위를 `SQL Injection`이라고 합니다. 

#

#### 로그인 기능을 위한 쿼리

![image](https://user-images.githubusercontent.com/81484874/194087528-b9f758fc-5154-473d-9c28-20d707a9f74f.png)
...
![image](https://user-images.githubusercontent.com/81484874/194089162-763258ec-7d63-46ca-8236-622f9b968533.png)
...
upw를 비교하는 부분이 주석 처리가 되어 그냥 uid가 admin인 데이터를 조회하게 됩니다. 
...
![image](https://user-images.githubusercontent.com/81484874/194092173-e19b9133-7d94-4e64-8d35-2ded8626a768.png)
...
user_table에서 uid가 admin이고 upw의 첫번째 글자가 'r' 또는 's' 인지 질의 (주석 --를 통해 공격 쿼리가 수행되도록 함)
...
user_table에서 uid가 admin이고 upw의 두번째 글자가 's' 또는 't' 인지 질의 (주석 --를 통해 공격 쿼리가 수행되도록 함)
